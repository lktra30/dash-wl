...
import type { MetaCampaignData } from "@/lib/types"
...
type SortField = "name" | "spend" | "roas" | "roi" | "clicks" | "purchases"
type SortDirection = "asc" | "desc"

export function AdsCampaignTable({ campaigns, brandColor = "#6366f1" }: AdsCampaignTableProps) {
  ...
  const getROASBadge = (roas: number) => {
    ...
    return { color: "bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300", label: "Ruim" }
  }
            ...
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-right">
                  <SortButton field="spend">Investimento</SortButton>
                </TableHead>
                ...
                <TableHead className="text-right">
                  <SortButton field="purchases">Conversões</SortButton>
                </TableHead>
                ...
                sortedCampaigns.map((campaign) => {
                  ...
                  return (
                    <TableRow key={campaign.id}>
                      ...
                      <TableCell className="text-right">
                        {campaign.purchases.toLocaleString('pt-BR')}
                      </TableCell>
                      <TableCell className="text-right">
